export declare abstract class Index {
    ...
    abstract searchByPrefix(prefix: string, returnWithDistance: true): Record<string, number>;
    ...
    abstract searchFuzzy(word: string, maxDistance: number, returnWithDistance: true): Record<string, number>;
